...
mixin _$WidgetEntityWrapper {
 ...
 WidgetEntityId get id; WidgetType get type; Set<WidgetArgument> get args;
...
@useResult
$Res call({
 WidgetEntityId id, WidgetType type, Set<WidgetArgument> args
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( WidgetEntityId id,  WidgetType type,  Set<WidgetArgument> args)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WidgetEntityWrapper() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( WidgetEntityId id,  WidgetType type,  Set<WidgetArgument> args)  $default,) {final _that = this;
switch (_that) {
case _WidgetEntityWrapper():
return $default(_that.id,_that.type,_that.args);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( WidgetEntityId id,  WidgetType type,  Set<WidgetArgument> args)?  $default,) {final _that = this;
switch (_that) {
case _WidgetEntityWrapper() when $default != null:
return $default(_that.id,_that.type,_that.args);case _:
  return null;
...
class _WidgetEntityWrapper extends WidgetEntityWrapper {
  const _WidgetEntityWrapper({required this.id, required this.type, required final  Set<WidgetArgument> args}): _args = args,super._();
  

@override final  WidgetEntityId id;
@override final  WidgetType type;
 final  Set<WidgetArgument> _args;
@override Set<WidgetArgument> get args {
  if (_args is EqualUnmodifiableSetView) return _args;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableSetView(_args);
}
