...
class _FixedColumnArgs extends FixedColumnArgs {
  const _FixedColumnArgs({this.crossAxisAlignment = CrossAxisAlignment.start,  List<WidgetEntity> children = const []}): _children = children,super._();
